Ext.define('Consulting.desktop.src.view.External.ExpenseMainController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.expenseattach',
    config: {
        checkAll: true,
        listen: {
            controller: {
...
this.showPrevious();
    ...
    onPreviousButtonClick: function() {
        ...
        switch (currentPanelId) {
            case 'expenseattachmentpanel':
                this.fireEvent('eventexpensePrev', currentPanel);
                break;          
            default:
    ...
    onSaveNextButtonClick: function() {
        ...
        switch (currentPanelId) {
            case 'ExpensePanel':
                this.fireEvent('eventexpenseattachSaveNext', currentPanel);
                break;
            default:
                console.error('Unknown panel:', currentPanelId);
        }
